...
unsafe extern "C" {
    // This symbol is defined in kernel.ld to be the start of the trampoline page.
    // It is placed just before the trampsec.
    pub fn trampoline();
}
...
#[unsafe(naked)]
#[unsafe(link_section = "trampsec")]
pub extern "C" fn userret(page_table: usize) {
